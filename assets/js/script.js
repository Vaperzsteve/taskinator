...
var tasks = [];
// end of variable decarations

// start of function expressions
var taskFormHandler = function (event) {
  ...
  // reset form fields through reset() function of forms
  formEl.reset();

  // ****** OTHER WAY TO RESET FORM *****
  // document.querySelector("input[name='task-name']").value = "";
  // document.querySelector("select[name='task-type']").selectedIndex = 0;


  // check if task is new or one being edited by seeing
  // if it has a data-task-id attribute
...
var editTask = function(taskId) {
  ...
  // update form button to show editing and add data-task-id to form to mark it as editing
